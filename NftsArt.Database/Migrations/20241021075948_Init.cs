    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionNfts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CollectionNfts_Collections_CollectionId",
                        column: x => x.CollectionId,
                        principalTable: "Collections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionNfts_Nfts_NftId",
                        column: x => x.NftId,
                        principalTable: "Nfts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NftCollectors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NftCollectors_AspNetUsers_CollectorId",
                        column: x => x.CollectorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NftCollectors_Nfts_NftId",
                        column: x => x.NftId,
                        principalTable: "Nfts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "https://localhost:7152/img/avatars/avatar.jpeg" },
                    { 2, "https://localhost:7152/img/avatars/avatar2.jpeg" },
                    { 3, "https://localhost:7152/img/avatars/avatar3.jpeg" },
                    { 4, "https://localhost:7152/img/avatars/avatar4.jpeg" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "https://localhost:7152/img/providers/coinbase-coin.png", "Coinbase" },
                    { 2, "https://localhost:7152/img/providers/metamask.png", "Metamask" },
                    { 3, "https://localhost:7152/img/providers/phantom.png", "Phantom" },
                    { 4, "https://localhost:7152/img/providers/trust-wallet.png", "Trust Wallet" },
                    { 5, "https://localhost:7152/img/providers/walletconnect.png", "Wallet Connect" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionNfts_CollectionId",
                table: "CollectionNfts",
                column: "CollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionNfts_NftId",
                table: "CollectionNfts",
                column: "NftId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NftCollectors_CollectorId",
                table: "NftCollectors",
                column: "CollectorId");

            migrationBuilder.CreateIndex(
                name: "IX_NftCollectors_NftId",
                table: "NftCollectors",
                column: "NftId");
